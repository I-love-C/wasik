...
# in container env want 4.0
WEBKIT := $(shell pkg-config --exists webkit2gtk-4.1 && echo webkit2gtk-4.1 || echo webkit2gtk-4.0)
...
$(BUILD)main.o: $(SRC)main.c
	c++ -c $(SRC)main.c -DWEBVIEW_GTK -O3 -std=c++11 `pkg-config --cflags gtk+-3.0 $(WEBKIT)` -o $(BUILD)main.o

$(BUILD)wasik: $(BUILD)main.o $(BUILD)bundle.o
	c++ $(BUILD)main.o $(BUILD)bundle.o `pkg-config --libs gtk+-3.0 $(WEBKIT)` -lwebview -o $(BUILD)wasik
